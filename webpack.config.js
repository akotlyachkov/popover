...
const baseConfig = {
    ...
    module: {
        rules: [
            {
                test: /\.html$/,
                loaders: ['awesome-typescript-loader', 'template-string-loader']
            },
            {
                test: /\.ts$/,
                loaders: [{
    ...
    plugins: [
        ...
        new ExtractTextPlugin('./debug/styles.css')
    ],
    resolve: {
...
minConfig.output.filename = './release/index.min.js';
minConfig.plugins = [
    new CleanWebpackPlugin('./release'),
    new ExtractTextPlugin('./release/styles.css'),
